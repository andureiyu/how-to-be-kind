...
const niceWays = [
  {
    ...
    description: "A few words left somewhere unexpected can carry someone through their whole day.",
    accent: "linear-gradient(145deg, #fde8d0, #f9c4a0)",
  },
  {
    id: 2,
    title: "Check in on a friend",
    description: "A simple 'hey, how are you' means more than you think.",
    accent: "linear-gradient(145deg, #d4f0e4, #b0e0c8)",
  },
  {
    id: 3,
    title: "Give a genuine compliment",
    description: "Not just on the surface — something you truly noticed about them.",
    accent: "linear-gradient(145deg, #d4e8f8, #b4ccec)",
  },
  {
    id: 4,
    title: "Share something beautiful",
    description: "A song, a sunset, a funny video. Joy is better when it's passed along.",
...
export default function BoardPage() {
  ...
  return (
    ...
    <div
      ...
      style={{ backgroundColor: "#f8ffd8", fontFamily: "var(--font-gamja), cursive" }}
    >
      ...
      <motion.a
        ...
        initial={{ opacity: 0 }}
        animate={{ opacity: 1, color: bgShift ? "rgba(255,255,255,0.85)" : "#9e823c" }}
        transition={{
      ...
      <div className="relative w-full" style={{ height: "100vh" }}>
          ...
          {gifs.map((gif, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ scale: 1.15, rotate: 0, boxShadow: "0 8px 30px rgba(107,142,58,0.2)", transition: { duration: 0.25 } }}
                onClick={() => setSelected(gif)}
              >
                <img src={gif.src} alt={gif.alt} className="h-full w-full rounded-2xl" style={{ objectFit: "cover" }} draggable={false} />
              </motion.div>
            );
          })}
        </div>
        ...
        >
          <div
            style={{ background: "radial-gradient(ellipse at center, #f8ffd8 55%, transparent 100%)", padding: "1.5rem 2.5rem", borderRadius: "2rem" }}
            className="flex flex-col items-center gap-2"
          >
            <h1 style={{ color: "#9e823c", fontSize: "clamp(1rem, 3.5vw, 2rem)", fontFamily: "var(--font-bakso), cursive", lineHeight: 1.4 }}>
              here are multiple virtual hugs,
            </h1>
            <p style={{ color: "#6dafed", fontSize: "clamp(0.85rem, 2.5vw, 1.3rem)", fontFamily: "var(--font-bakso), cursive", fontStyle: "italic" }}>
              cuz we need them.
            </p>
            <motion.p
              className="mt-1"
              style={{ color: "#b8a060", fontSize: "clamp(0.65rem, 1.5vw, 0.8rem)", fontFamily: "var(--font-bakso), cursive", letterSpacing: "0.04em" }}
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
      ...
      {/* Scroll hint */}
      <motion.div className="flex justify-center py-6" initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 1.2, delay: 2.2 }}>
        <motion.span
          style={{ color: "#b8a060", fontSize: "clamp(0.65rem, 1.4vw, 0.78rem)", fontFamily: "var(--font-bakso), cursive", letterSpacing: "0.12em" }}
          animate={{ y: [0, 5, 0] }}
      ...
      <div className="flex min-h-screen flex-col justify-center" style={{ backgroundColor: "#f8ffd8" }}>
      ...
      >
        ...
        >
          <p style={{ color: "rgba(255,255,255,0.35)", fontSize: "clamp(0.65rem, 1.5vw, 0.8rem)", fontFamily: "var(--font-bakso), cursive", letterSpacing: "0.08em" }}>
          ...
          >
            ...
            >
              <div
                ...
                style={{ background: "linear-gradient(145deg, #eef4d4, #e2ecc0)", border: "3px solid rgba(168,191,106,0.4)", maxWidth: "min(85vw,420px)", maxHeight: "min(75vh,420px)" }}
              >
                <img src={selected.src} alt={selected.alt} className="block w-full h-full" style={{ objectFit: "contain", maxHeight: "min(75vh,420px)" }} draggable={false} />
              </div>
              <motion.p
                style={{ color: "rgba(255,255,255,0.7)", fontSize: "clamp(0.6rem,1.5vw,0.8rem)", fontFamily: "var(--font-bakso), cursive", letterSpacing: "0.08em" }}
        ...
        {selectedWallpaper && (
          ...
          >
            ...
            >
              ...
              >
                <div style={{ width: "100%", aspectRatio: "4 / 3", borderRadius: "1.2rem", background: selectedWallpaper.accent, position: "relative", overflow: "hidden" }}>
                ...
                <div className="flex flex-col gap-1.5 px-3 pt-3 pb-2">
                  <h3 style={{ color: "#6b8a3a", fontSize: "clamp(0.9rem, 4vw, 1.1rem)", fontFamily: "var(--font-bakso), cursive", lineHeight: 1.3 }}>
                    {selectedWallpaper.title}
                  </h3>
                  <div style={{ height: "1px", background: "rgba(168, 191, 106, 0.35)" }} />
...
function NiceWayCard({
  ...
  return (
    <motion.div
      ...
      whileHover={{ scale: 1.02, boxShadow: "0 14px 38px rgba(107,142,58,0.2)", transition: { duration: 0.25 } }}
      onClick={onClick}
    >
      {/* Image placeholder */}
      <div
      ...
      <div className="flex flex-col gap-2 px-4 py-4">
        <h3 style={{ color: "#6b8a3a", fontSize: "clamp(0.9rem, 4.5vw, 1.05rem)", fontFamily: "var(--font-bakso), cursive", lineHeight: 1.3 }}>
          {way.title}
        </h3>
        <div style={{ height: "1px", background: "rgba(168, 191, 106, 0.35)" }} />
          ...
          >
            ...
            >
              ...
              >
                ...
                <span style={{ color: "rgba(255,255,255,0.3)", fontSize: "clamp(0.5rem, 0.9vw, 0.65rem)", fontFamily: "var(--font-bakso), cursive", letterSpacing: "0.22em", textTransform: "uppercase" }}>add image</span>
              </motion.div>
            </div>
          </div>
        </motion.div>
